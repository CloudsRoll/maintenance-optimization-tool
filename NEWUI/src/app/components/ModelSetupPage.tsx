              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 bg-input-background rounded-md border border-border focus:outline-none focus:ring-2 focus:ring-ring"
                  />
                  <p className="text-sm text-gray-500 mt-2">Cost of performing maintenance before failure occurs.</p>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 bg-input-background rounded-md border border-border focus:outline-none focus:ring-2 focus:ring-ring"
                  />
                  <p className="text-sm text-gray-500 mt-2">Cost incurred after a component fails.</p>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 bg-input-background rounded-md border border-border focus:outline-none focus:ring-2 focus:ring-ring"
                  />
                  <p className="text-sm text-gray-500 mt-2">Cost of moving or handling each component during maintenance.</p>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 bg-input-background rounded-md border border-border focus:outline-none focus:ring-2 focus:ring-ring"
                  />
                  <p className="text-sm text-gray-500 mt-2">Cost of replacing components that are not in optimal (green) condition.</p>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 bg-input-background rounded-md border border-border focus:outline-none focus:ring-2 focus:ring-ring"
                  />
                  <p className="text-sm text-gray-500 mt-2">Penalty cost for delaying maintenance too long.</p>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 bg-input-background rounded-md border border-border focus:outline-none focus:ring-2 focus:ring-ring"
                  />
                  <p className="text-sm text-gray-500 mt-2">Penalty cost for performing maintenance too early.</p>
                </div>
              </div>
            </section>
